describe('template spec', () => {
  ...
  it('pasienbaru', function() {
    ...
    cy.get('input[type=radio][value=bayar_asuransi]').check();
    cy.get('input#asuransi').type('BPJS Kesehatan');
    cy.get('input#no_polis').type('112456');
    cy.get('input[type=radio]#radio_rencana_pembayaran2').check();
